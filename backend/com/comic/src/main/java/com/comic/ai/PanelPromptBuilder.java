...
public class PanelPromptBuilder {
    ...
    public String buildMultiShotPrompt(String visualStyle, Map<String, Object> panelInfo,
        ...
        sb.append("## 嘴巴运动与说话人约束（最高优先级）\n");
        sb.append("本视频为音画同步生成，只有对白中标注的说话人可以产生嘴部动作，其他所有角色必须保持闭嘴。\n");
        sb.append("- 仅当说话人正在画面中可见时，该说话人可以有适度的嘴部开合动作来配合对白，但动作幅度必须自然克制。\n");
        sb.append("- 画面中所有非说话人的角色，嘴巴必须始终保持自然闭合，不得有任何嘴唇开合、蠕动或口型运动。非说话人只能通过眼神、表情、头部动作表达反应。\n");
        sb.append("- 当对白说话人为旁白、画外音、内心独白、或不在画面中的角色时，画面内所有角色的嘴巴必须完全闭合静止，保持倾听或自然状态，绝对禁止任何嘴部运动。\n");
        sb.append("- 角色嘴巴的自然静止状态：嘴唇自然闭合或微笑时嘴角微扬（不露齿）。允许的短暂微张仅限惊讶表情（一条细缝，不伴随蠕动）。\n");
        sb.append("- 绝对禁止非说话人的任何嘴部动作：嘴唇开合、舌头运动、露齿、口型蠕动、咀嚼、吞咽、不自主的面部肌肉运动。\n\n");
        ...
        sb.append("【嘴巴运动约束 - 最强约束】非说话人角色绝对禁止任何嘴部运动：张嘴、嘴唇开合蠕动、露齿、口型运动、舌头活动、咀嚼吞咽。");
        sb.append("仅对白中标注的说话人且在画面中可见时可以有嘴部动作，其余角色嘴巴必须完全静止闭合。");
        sb.append("当说话人为旁白或不在画面中时，画面内所有角色一律闭嘴，不得有任何嘴部反应。");
        sb.append("非说话人的表情只能通过眼睛、眉毛、头部姿态传达。\n");
